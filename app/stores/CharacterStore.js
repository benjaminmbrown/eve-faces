...
class CharacterStore {
	...
	onCharacterSuccess(data){
		...
		let localData = localStorage.getItem('EF') ? JSON.parse(localStorage.getItem("EF")) : {};
	...
	onReportSuccess(){
		...
		localStorage.setItem('EF', JSON.stringify(localData));
		toastr.warning('Character reported!');
	}
